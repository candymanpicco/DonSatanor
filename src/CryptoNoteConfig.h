...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x31dc;
...
const uint64_t MONEY_SUPPLY                                  = (uit64_t)(-1);
...
const char     CRYPTONOTE_NAME[]                             = "donsatanorcoin";
...
const int      P2P_DEFAULT_PORT                              = 65531;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 65532;
